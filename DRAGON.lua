...
تم تطوير السورس من قبل المبرمج افاتار
...
sudo_users = {SUDO,1135359831,1183747742,1321555749,1925182886}   
...
send(msg.chat_id_, msg.id_,'⋆ تم تحديث ال')
dofile('DRAGON.lua')  
end
...
if text == 'السورس' or text == ' افاتار' or text == 'يا ' or text == 'ياسورس'  then
local Text =[[
[⋆](t.me/php_14) ━━━━━━[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑](t.me/php_14)━━━━━━ [⋆](t.me/php_14)      
                      
  [𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑](t.me/php_14)

[⋆](t.me/php_14) ━━━━━━[𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑](t.me/php_14)━━━━━━ [⋆](t.me/php_14)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙰𝙵𝙰𝚃𝙰𝚁 ',url="t.me/php_30"},{text = '𝙰𝙱𝙳𝙰𝙻𝙻𝙰𝙷',url="t.me/A_S_Z_16"},{text = '𝙰𝙻𝙰𝚉𝙸𝚉𝚈',url="t.me/alazizy"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐅𝐀𝐓𝐀𝐑 ', url="t.me/php_14"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/php_14/111=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'مطور سورس' or text == 'مبرمج السورس' or text == 'يا افاتار' then
local Text = [[
⋆ يمكنك التواصل معي..↑↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙰𝙵𝙰𝚃𝙰𝚁 ',url="t.me/php_30"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmsst13/908&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
